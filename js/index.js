...
battle.queue.push(new MoveAction(battler0, battler1, MoveDex.tackle), new MoveAction(battler0, battler1, MoveDex.tackle), new MoveAction(battler0, battler1, MoveDex.tackle), new MoveAction(battler0, battler1, MoveDex.tackle));
