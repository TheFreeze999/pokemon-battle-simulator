...
battle.queue.push(new MoveAction(battler0, battler0, MoveDex.hone_claws), new MoveAction(battler1, battler0, MoveDex.energy_ball), new MoveAction(battler0, battler1, MoveDex.tackle), new MoveAction(battler1, battler0, MoveDex.tackle));
